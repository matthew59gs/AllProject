...
It supports UIAutomation for the applications which implmented IUIAuDEBUG_EXIST_DISAPPEARtomation, such as MFC, Windows Form, WPF, Modern UI(Metro UI), Qt, Firefox and Chrome.
